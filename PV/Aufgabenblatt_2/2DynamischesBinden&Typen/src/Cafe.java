...
public class Cafe {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("6: ((Drink) espresso).getTemperature()	: " + ((Drink) espresso).getTemperature()); // Der Interpreter schaut nicht nach Typen deswegen ist espresso ein Coffee 
